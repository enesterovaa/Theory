...
[HTTP статус коды сервера](#http-статус-коды-сервера)

[Что такое ядро браузера](#что-такое-ядро-браузера)

[Какие браузеры какие ядра используют](#какие-браузеры-какие-ядра-используют)

[Что такое API](#что-такое-api)

[Что такое эндпоинты](#что-такое-эндпоинты)

[URL, URI, URN](#URL-URI-URN)

[Идемпотентные HTTP методы](#идемпотентные-http-методы)

[Безопасные HTTP методы](#безопасные-http-методы)

[Идентификация, аутентификация, авторизация](#идентификация-аутентификация-авторизация)

[Что такое IP](#что-такое-ip)

[Что такое октеты в DNS](#что-такое-октеты-в-dns)

[Что такое порт, сколько портов у Linux сервера](#что-такое-порт-сколько-портов-у-Linux-сервера)

[Уровни OSI](#уровни-osi)

[Хедеры HTTP запросов](#хедеры-http-запросов)
...
например, он может сохранять статистику. 
